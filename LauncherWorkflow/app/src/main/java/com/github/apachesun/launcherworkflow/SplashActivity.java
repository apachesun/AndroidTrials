...
public class SplashActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(final LayoutInflater inflater, ViewGroup container,
            ...
            if (getArguments().getInt(ARG_SECTION_NUMBER) == totalPages) {
                //Find the layout with the id you gave in on the xml
                RelativeLayout rl = (RelativeLayout) rootView.findViewById(R.id.fragment_spalsh_layout);

                //And now you can add the buttons you need, because it's a fragment, use getActivity() as context
                Button bt = new Button(getActivity());
                bt.setText(R.string.accept_agreement);
                bt.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        LauncherData.logSplashCompleted(view.getContext());
